	...
	return (
		<div>
            ...
            {/* onSubmit={handleSubmit} */}
				<div className={PS2P.className} style={TextWrapperStyle}>
					<div className={PS2P.className}  style={UsernameStyle}>
						Nickname:
					</div>
					<input
						type="text"
				...
				<div className={PS2P.className} style={ImageWrapperStyle}>
					<button type="button"
						// onClick={resetAvatar}
